...
export class ProjectStorage {
  ...
  public static getTechnicalAnalysisForProject(projectId: string): any | undefined {
    const project = this.getProject(projectId);
    return project?.technicalAnalysis;
  }

  public static saveTechnicalAnalysisForProject(
    projectId: string,
  ...
  public static getCatalystAndRiskAnalysisForProject(projectId: string): any | undefined {
    const project = this.getProject(projectId);
    return project?.catalystAndRiskAnalysis;
  }

  public static saveCatalystAndRiskAnalysisForProject(
    projectId: string,
    catalystAndRiskAnalysis: any
  ): ResearchProject | undefined {
    const project = this.getProject(projectId);
    if (!project) return undefined;
